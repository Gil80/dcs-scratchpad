...
function loadInKW(StartWaypoint,Waypoints,Seat)
  ...
  do -- mapping
    ...
    keys['B2'] = {code = '3009', delay = 15}
    keys['R2'] = {code = '3014', delay = 15}
    keys['L1'] = {code = '3001', delay = 15}      
    keys['L2'] = {code = '3002', delay = 15}       
    keys['L4'] = {code = '3004', delay = 15}    
    keys['R5'] = {code = '3017', delay = 15}  
    keys['R4'] = {code = '3016', delay = 15}     
    keys['ENTER'] = {code = '3089', delay = 15}     
    keys['CLR'] = {code = '3091', delay = 15}         
    ...
    for i =1,l do
      ...
      base = base + 1
      keys[c] = {code = tostring(base), delay = 15}  
    end
  end -- maping
